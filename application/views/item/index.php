...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-list" aria-hidden="true"></i> <?= $title; ?></h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <?= form_error('jenis_lhu', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
                ...
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('item'); ?>" method="post">
                        <div class="modal-body">
                            <input type="text" class="form-control" id="jenis_lhu" name="jenis_lhu" placeholder="Jenis LHU">
                        </div>
